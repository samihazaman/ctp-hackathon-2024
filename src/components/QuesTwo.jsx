        ...
        <div className="quesBox">
          ...
          <div className="quesAns">
            <select name="college" id="college" onChange={handleOptionChange}>
              ...
              <option value="CUNY Graduate School of Public Health & Health Policy">CUNY Graduate School of Public Health & Health Policy</option>
              ...
              <option value="CUNY School of Professional Studies | CUNY SPS">CUNY School of Professional Studies | CUNY SPS</option>
              ...
              <option value="CUNY School of Medicine">CUNY School of Medicine</option>
              ...
              <option value="Craig Newmark Graduate School of Journalism at CUNY">Craig Newmark Graduate School of Journalism at CUNY</option>
            </select>
          </div>
        </div>
      </form>
